...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scores_result', 'loser', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='lost_results', to=orm['scores.Team']), keep_default=False)
