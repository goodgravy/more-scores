...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Point.cumulative'
        db.delete_column('scores_point', 'cumulative')


    def backwards(self, orm):
        
        # Adding field 'Point.cumulative'
        db.add_column('scores_point', 'cumulative', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
