...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scores_point', (
            ...
            ('cumulative', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('scores', ['Point'])

        # Changing field 'Result.played'
        db.alter_column('scores_result', 'played', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Result.played'
        db.alter_column('scores_result', 'played', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'scores.point': {
            ...
            'cumulative': ('django.db.models.fields.IntegerField', [], {}),
            'for_this_match': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scores.Result']", 'unique': 'True'}),
